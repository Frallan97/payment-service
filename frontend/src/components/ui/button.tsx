  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-error-500 text-white shadow-sm hover:bg-error-600 active:bg-error-600",
        outline:
          "border border-neutral-300 bg-background shadow-sm hover:bg-neutral-50 hover:border-neutral-400 text-neutral-700",
        secondary:
          "bg-neutral-100 text-neutral-700 shadow-sm hover:bg-neutral-200 active:bg-neutral-200",
        ghost: "text-neutral-600 hover:bg-neutral-100 hover:text-neutral-700",
